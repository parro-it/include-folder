...
var includeFolder = require('../lib/include-folder');
...
describe('include_folder', function () {
  ...
  describe('generated source code', function () {
    var source = includeFolder.buildSource('./test/files', /^[^.].*$/);
    var folderFun = new Function('require', '__dirname', source); // eslint-disable-line no-new-func
    var folderModule = folderFun(require, __dirname + '/files/');
